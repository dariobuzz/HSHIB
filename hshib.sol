...
contract HSHIB is IBEP20, Auth {
    using SafeMath for uint256;
    IPinkAntiBot public pinkAntiBot;

   // BSC: 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002
    address pinkAntiBotaddr= 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5;
   ...
   /// uint256 public constant MASK = type(uint128).max;
    ...
    string constant _name = "HYPER SHIBA INU";
    string constant _symbol = "HSHIB";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000000 * (10**18);// 0.25%
    ...
    uint256 totalFee = liquidityFee.add(buybackFee).add(reflectionFee).add(marketingFee); 
